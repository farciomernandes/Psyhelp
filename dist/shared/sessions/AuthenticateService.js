...
var AuthenticateService = /** @class */ (function () {
    ...
    AuthenticateService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var userRepository, psicologoRepository, findUserEmail, findPsicologoEmaik;
                    ...
                    case 2:
                        ...
                        if (findPsicologoEmaik) {
                            if (findPsicologoEmaik.password == password) {
                                return [2 /*return*/, findPsicologoEmaik];
                            }
                            else {
                                throw new Error("Invalid credentials");
                            }
